...
term =
  tok "(" *> exprParser <* tok ")" <|> uncurry Var <$> getPId <|>
...
stmtParser =
  ifParser <|> doWhileParser <|> whileParser <|> forParser <|> switchParser <|>
  caseParser <|>
  caseDefaultParser <|>
  returnParser <|>
  breakParser <|>
